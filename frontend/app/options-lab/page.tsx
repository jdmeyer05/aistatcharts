...
export default function OptionsLab() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Options Lab</h1>
        <p className="text-text-secondary text-sm mt-1">Black-Scholes pricing, Greeks calculator, and multi-leg strategy P&L modeler.</p>
      </div>
