...
export default function HigherGreeksPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Higher-Order Greeks</h1>
        <p className="text-text-secondary text-sm mt-1">2nd and 3rd order sensitivities: vanna, charm, volga, speed, zomma, color.</p>
      </div>
              ...
              <div className="card space-y-4">
                ...
                {aiGreekContent && (
                  <div className="prose prose-sm max-w-none text-sm" dangerouslySetInnerHTML={{
                    __html: aiGreekContent.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;")
