...
export default function PortfolioGreeksPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Portfolio Greeks</h1>
        <p className="text-text-secondary text-sm mt-1">Enter positions, see aggregate risk, model scenarios, plan delta hedges.</p>
      </div>
