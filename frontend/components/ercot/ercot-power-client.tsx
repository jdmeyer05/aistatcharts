...
export default function ErcotPowerClient() {
        ...
        return (
          <div className="card space-y-4">
            <Plot data={[
              ...
              config={{ displayModeBar: false, responsive: true }} style={{ width: "100%" }} />
            <p className="text-xs text-text-muted">The &ldquo;duck curve&rdquo; shows the belly created by midday solar reducing net load, followed by a steep evening ramp as solar drops off.</p>
          </div>
        );
      })()}
