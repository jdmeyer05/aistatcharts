...
TICKER_SYMBOLS = ["SPY", "QQQ", "DIA", "IWM", "TLT", "GLD", "USO", "BTC-USD", "DX-Y.NYB", "^VIX"]
TICKER_LABELS = {
    "SPY": "S&P 500 (SPY)", "QQQ": "Nasdaq (QQQ)", "DIA": "Dow (DIA)", "IWM": "Russell (IWM)",
    "TLT": "20Y Bond (TLT)", "GLD": "Gold (GLD)", "USO": "Oil (USO)", "BTC-USD": "Bitcoin (BTC)",
