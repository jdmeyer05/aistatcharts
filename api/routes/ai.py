...
PAGE_CONTEXT: dict[str, str] = {
    ...
    "home_page": (
        ...
        "- `todays_schedule` / `upcoming_events_2w` — scheduled risk on the clock.\n"
    ...
    "home_es_briefing": (
        ...
        "`distance_pct`, `side`), `nearest` (closest reference level), `schedule` (today's releases with "
        "`time_et`, `impact`, `minutes_away`, `status`, `before_open`, `derived`), `next_event`, `cta` "
        ...
        "is never directional; do not turn it into a bias.\n"
